...
class UserProfileList(generics.ListCreateAPIView):
    """
    List all user_profiles, or create a new user_profile.
    """
...
class UserProfileDetail(generics.RetrieveUpdateDestroyAPIView):
    """
    Retrieve, update or delete a user_profile instance.
    """
    def get_object(self, request, pk):
        """
        Obtains a single user_profile object instance via pk lookup.
        """
        try:
    ...
    def get(self, request, pk, format=None):
        ...
        return Response({'profile':serializer.data}, template_name='profile.html')
...
class GroupDetail(generics.RetrieveUpdateDestroyAPIView):
    ...
    def get_object(self, request, pk):
        """
        Obtains a single group object instance via pk lookup.
        """
        try:
...
def profile(request):
    ...
    return detail.get(request, user_profile.id)
